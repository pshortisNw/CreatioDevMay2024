	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_z8bz422_caption)#",
					"color": "default",
					"disabled": false,
					"size": "large",
			...
			{
				"operation": "insert",
				"name": "MenuItem_xmipbth",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_xmipbth_caption)#",
					"visible": true
				},
				"parentName": "DataTable",
				"propertyName": "bulkActions",
