	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_xwgrmp9_caption)#",
					"visible": true,
					"clicked": {
			...
			},
        {
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrType_m95phl4;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.PDS_UsrOfferType_hwo3pxx;
					var offerTypeId = "";
					if (offerTypeObject) {
