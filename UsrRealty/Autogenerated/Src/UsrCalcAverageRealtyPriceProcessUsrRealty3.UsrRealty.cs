namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageRealtyPriceProcessUsrRealty3MethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageRealtyPriceProcessUsrRealty3MethodsWrapper : ProcessModel
	{

		public UsrCalcAverageRealtyPriceProcessUsrRealty3MethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var esq = new EntitySchemaQuery(UserConnection.EntitySchemaManager, "Supervisor");
