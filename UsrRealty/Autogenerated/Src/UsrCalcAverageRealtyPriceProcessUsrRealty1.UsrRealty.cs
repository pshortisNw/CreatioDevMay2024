namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageRealtyPriceProcessUsrRealty1MethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageRealtyPriceProcessUsrRealty1MethodsWrapper : ProcessModel
	{

		public UsrCalcAverageRealtyPriceProcessUsrRealty1MethodsWrapper(Process process)
			: base(process) {
