namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageRealtyPriceProcessUsrRealty4MethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageRealtyPriceProcessUsrRealty4MethodsWrapper : ProcessModel
	{

		public UsrCalcAverageRealtyPriceProcessUsrRealty4MethodsWrapper(Process process)
			: base(process) {
